...
const CaseCreatePage = {
                    ...
                    <div class="victim-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group" style="flex: 0 1 80px;">
                                <label for="${blockId}_gender">เพศ</label>
                                <select id="${blockId}_gender" name="${blockId}_gender" style="min-width: 60px;">
                                    <option value="">--</option>
    ...
    collectVictimData(blockId) {
        ...
        return {
            ...
            gender: document.getElementById(`${blockId}_gender`)?.value || '',
